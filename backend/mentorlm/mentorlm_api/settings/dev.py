...
# Имя файла выгрузки едет в Content-Disposition, а браузер не отдаёт этот
# заголовок кросс-доменному JS без явного разрешения — и файл сохранился бы
# под именем-заглушкой. В проде фронт и API за одним nginx, поэтому строка
# нужна только здесь.
