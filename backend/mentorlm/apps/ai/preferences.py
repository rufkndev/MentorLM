...
DEFAULTS = {
    ...
    "memory_use": "auto",
    # По умолчанию храним переписку 30 дней: столько же обещано в юр-документах,
    # и это меньше данных о пользователе «на всякий случай». Кто хочет — меняет
    # срок (вплоть до «не удалять») в настройках, вкладка «Данные».
