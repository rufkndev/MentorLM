...
export default function BillingLayout({
  ...
  return (
    <SubscriptionProvider>
      {/* Плавающая кнопка «Назад» в левом верхнем углу. Ведёт именно в /chat,
          а не назад по истории: на страницу оплаты приходят и по прямой
          ссылке, и редиректом с формы ЮKassa, — history.back() в этих случаях
